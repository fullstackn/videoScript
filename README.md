...
4. On next screen choose "Other - explore other products and data permissions such as ads management, WhatsApp and more. You'll be asked to select an app type and then you can add the permissions and products you need."
